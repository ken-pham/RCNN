...
class DataGenerator(Sequence):
    ...
    def __init__(self, dataset, config, shuffle=True, augmentation=False,
...
class MaskRCNN(object):
    ...
    def compile(self):
        ...
        """
        # Optimizer object
        optimizer = SGD(self.lr_scheduler(100), momentum = self.config.LEARNING_MOMENTUM, 
