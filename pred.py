...
from model_pred import Polygons, Mask
...
coco_config = configuration(BACKBONE = "resnet101",  NUM_CLASSES =  2,  class_names = ["BG"], IMAGES_PER_GPU = 1, 
...
class instance_segmentation():
    def __init__(self, infer_speed = None):
        ...
        coco_config.class_names = ['BG','butterfly','squirrel']
    ...
    def select_target_classes(self,BG = False, butterfly = False, squirrel = False):

        detected_classes = {}
        target_class_names = [BG,butterfly,squirrel]
